import"./modulepreload-polyfill-B5Qt9EMX.js";import{T as u,o as w,p as _,j as F,V as A,q as D,A as B,R as P}from"./index-z_3bUTQL.js";import{r as h,h as I}from"./utils-DQaJ-aSb.js";import{R as M}from"./RenderTexture-DRp0-QYY.js";import{G as V}from"./Graphics-BSDvj37r.js";const y=class p{constructor(t){if(t instanceof u)this.texture=t,w(this,p.defaultOptions,{});else{const e={...p.defaultOptions,...t};w(this,e,{})}}get alpha(){return this._alpha}set alpha(t){this._alpha=Math.min(Math.max(t,0),1),this._updateColor()}get tint(){return _(this._tint)}set tint(t){typeof t=="number"?this._tint=t:this._tint=F.shared.setValue(t??16777215).toBgrNumber(),this._updateColor()}_updateColor(){this.color=this._tint+((this._alpha*255|0)<<24)}};y.defaultOptions={anchorX:0,anchorY:0,x:0,y:0,scaleX:1,scaleY:1,rotation:0,tint:16777215,alpha:1};let E=y;const C={vertex:{attributeName:"aVertex",format:"float32x2",code:`
